...
class AuditLogCsvParserTest {
    ...
    private fun getCsvLines(timestamp: String): List<String> {
        ...
        return listOf(
            "id,entityType,action,timestamp,entityId,userId",
            "82e16049-a9fb-4f69-b6f7-3336b68f2ae4,$projectType,Add,$timestamp,63112726-d5d9-4408-ab14-b3c96b4aacf5,b1ca0006-8c10-43dd-8dbd-05dbe3c62d3d",
            "045e2ef6-a9f8-43d9-9c33-da8cf3a0ff2f,$projectType,Edit,$timestamp,63112726-d5d9-4408-ab14-b3c96b4aacf5,b1ca0006-8c10-43dd-8dbd-05dbe3c62d3d",
            "07f641d4-077e-4f08-978d-3b6c9587f4bf,$projectType,Delete,$timestamp,63112726-d5d9-4408-ab14-b3c96b4aacf5,7771ecef-968f-4c32-86d7-2f81a8a44f3b",
            "c93e2a50-fc82-47a3-970a-bae31bece454,$projectType,Add,$timestamp,63112726-d5d9-4408-ab14-b3c96b4aacf5,7771ecef-968f-4c32-86d7-2f81a8a44f3b",
            "9da65913-ee18-440f-8d60-58f5a1d0bdd3,$taskType,Add,$timestamp,4f81da36-c0ca-4521-a753-8054992796fe,26553047-a4ae-4a6c-81ec-89b21aebb11c",
            "49c2ba8e-1c6c-4184-9202-b29b64dadaba,$taskType,Add,$timestamp,4f81da36-c0ca-4521-a753-8054992796fe,26553047-a4ae-4a6c-81ec-89b21aebb11c",
            ...
            "39cdfa5b-96fb-4aa6-9d7b-6937c9875c7d,$taskType,Edit,$timestamp,4f81da36-c0ca-4521-a753-8054992796fe,34afe18e-9393-41e1-8aa5-17ba77d2f349",
        )
    }

    private fun List<String>.toCsvData(): CsvData {
        var data: CsvData = ""
        this.forEach {
            data += it + "\n"
        }
